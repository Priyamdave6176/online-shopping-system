...
?>
	...
	<div class="wait overlay" style="background-color:lightblue;">
	...
	<div class="container-fluid" style="background-color:lightblue;">
				<!-- row -->
					...
					<div class="login-marg" style="background-color:lightblue;">
						<!-- Billing Details -->
						...
						<!-- /Billing Details -->
								...
								<form onsubmit="return false" id="login" class="login100-form ">
									<div class="billing-details jumbotron" style="background-color:lightblue;">
                                    <div class="section-title">
                                        <h2 class="login100-form-title" style="color:blue;" >Login Here</h2>
                                    </div>
