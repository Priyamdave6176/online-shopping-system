			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +91-9982790270</a></li>
						<li><a href="#"><i class="fa fa-envelope-o"></i>davep90167@gmail.com</a></li>
					...
					<div class="row">
						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								...
								<!-- Cart -->
								<div class="dropdown"  style="margin-left:600%;">
									...
									<div class="cart-dropdown">
										...
										<div class="cart-btns">
												<a href="cart.php"><i class="fa fa-edit"></i>  edit cart</a>
